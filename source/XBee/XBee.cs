    ...
    public class XBee : Module
    {
        public Api.XBee Api
        {
            get
            {
                if (_api == null)
                {
                    _api = new Api.XBee(new XBeeConnection(SerialLine));
                    _api.Open();
                }
        ...
        public GTI.Serial SerialLine
        {
            ...
            {
                if (_serialLine == null)
                    Configure(9600, GTI.Serial.SerialParity.None, GTI.Serial.SerialStopBits.One, 8);
        ...
        private GTI.Serial _serialLine;
        ...
        public void Configure(int baudRate, GTI.Serial.SerialParity parity, GTI.Serial.SerialStopBits stopBits, int dataBits)
        {
            ...
            _serialLine = new GTI.Serial(_socket, baudRate, parity, stopBits, dataBits, GTI.Serial.HardwareFlowControl.NotRequired, this);
        }
    }
}
